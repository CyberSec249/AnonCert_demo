...
// DeployStore deploys a new kvtabletest, binding an instance of Store to it.
...
// Store is an auto generated Go binding around a Solidity kvtabletest.
type Store struct {
	StoreCaller     // Read-only binding to the kvtabletest
	StoreTransactor // Write-only binding to the kvtabletest
	StoreFilterer   // Log filterer for kvtabletest events
}

// StoreCaller is an auto generated read-only Go binding around a Solidity kvtabletest.
type StoreCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// StoreTransactor is an auto generated write-only Go binding around a Solidity kvtabletest.
type StoreTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// StoreFilterer is an auto generated log filtering Go binding around a Solidity kvtabletest events.
type StoreFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// StoreSession is an auto generated Go binding around a Solidity kvtabletest,
// with pre-set call and transact options.
type StoreSession struct {
	Contract     *Store            // Generic kvtabletest binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// StoreCallerSession is an auto generated read-only Go binding around a Solidity kvtabletest,
// with pre-set call options.
type StoreCallerSession struct {
	Contract *StoreCaller  // Generic kvtabletest caller binding to set the session for
	CallOpts bind.CallOpts // Call options to use throughout this session
}

// StoreTransactorSession is an auto generated write-only Go binding around a Solidity kvtabletest,
// with pre-set transact options.
type StoreTransactorSession struct {
	Contract     *StoreTransactor  // Generic kvtabletest transactor binding to set the session for
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// StoreRaw is an auto generated low-level Go binding around a Solidity kvtabletest.
type StoreRaw struct {
	Contract *Store // Generic kvtabletest binding to access the raw methods on
}

// StoreCallerRaw is an auto generated low-level read-only Go binding around a Solidity kvtabletest.
type StoreCallerRaw struct {
	Contract *StoreCaller // Generic read-only kvtabletest binding to access the raw methods on
}

// StoreTransactorRaw is an auto generated low-level write-only Go binding around a Solidity kvtabletest.
type StoreTransactorRaw struct {
	Contract *StoreTransactor // Generic write-only kvtabletest binding to access the raw methods on
}

// NewStore creates a new instance of Store, bound to a specific deployed kvtabletest.
...
// NewStoreCaller creates a new read-only instance of Store, bound to a specific deployed kvtabletest.
...
// NewStoreTransactor creates a new write-only instance of Store, bound to a specific deployed kvtabletest.
...
// NewStoreFilterer creates a new log filterer instance of Store, bound to a specific deployed kvtabletest.
...
// bindStore binds a generic wrapper to an already deployed kvtabletest.
...
// Items is a free data retrieval call binding the kvtabletest method 0x48f343f3.
//
...
// Version is a free data retrieval call binding the kvtabletest method 0x54fd4d50.
//
...
// SetItem is a paid mutator transaction binding the kvtabletest method 0xf56256c7.
//
