...
// DeployBN256 deploys a new kvtabletest, binding an instance of BN256 to it.
...
// BN256 is an auto generated Go binding around a Solidity kvtabletest.
type BN256 struct {
	BN256Caller     // Read-only binding to the kvtabletest
	BN256Transactor // Write-only binding to the kvtabletest
	BN256Filterer   // Log filterer for kvtabletest events
}

// BN256Caller is an auto generated read-only Go binding around a Solidity kvtabletest.
type BN256Caller struct {
	contract *bind.BoundContract // Generic kvtabletest wrapper for the low level calls
}

// BN256Transactor is an auto generated write-only Go binding around a Solidity kvtabletest.
type BN256Transactor struct {
	contract *bind.BoundContract // Generic kvtabletest wrapper for the low level calls
}

// BN256Filterer is an auto generated log filtering Go binding around a Solidity kvtabletest events.
type BN256Filterer struct {
	contract *bind.BoundContract // Generic kvtabletest wrapper for the low level calls
}

// BN256Session is an auto generated Go binding around a Solidity kvtabletest,
// with pre-set call and transact options.
type BN256Session struct {
	Contract     *BN256            // Generic kvtabletest binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// BN256CallerSession is an auto generated read-only Go binding around a Solidity kvtabletest,
// with pre-set call options.
type BN256CallerSession struct {
	Contract *BN256Caller  // Generic kvtabletest caller binding to set the session for
	CallOpts bind.CallOpts // Call options to use throughout this session
}

// BN256TransactorSession is an auto generated write-only Go binding around a Solidity kvtabletest,
// with pre-set transact options.
type BN256TransactorSession struct {
	Contract     *BN256Transactor  // Generic kvtabletest transactor binding to set the session for
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// BN256Raw is an auto generated low-level Go binding around a Solidity kvtabletest.
type BN256Raw struct {
	Contract *BN256 // Generic kvtabletest binding to access the raw methods on
}

// BN256CallerRaw is an auto generated low-level read-only Go binding around a Solidity kvtabletest.
type BN256CallerRaw struct {
	Contract *BN256Caller // Generic read-only kvtabletest binding to access the raw methods on
}

// BN256TransactorRaw is an auto generated low-level write-only Go binding around a Solidity kvtabletest.
type BN256TransactorRaw struct {
	Contract *BN256Transactor // Generic write-only kvtabletest binding to access the raw methods on
}

// NewBN256 creates a new instance of BN256, bound to a specific deployed kvtabletest.
...
// NewBN256Caller creates a new read-only instance of BN256, bound to a specific deployed kvtabletest.
...
// NewBN256Transactor creates a new write-only instance of BN256, bound to a specific deployed kvtabletest.
...
// NewBN256Filterer creates a new log filterer instance of BN256, bound to a specific deployed kvtabletest.
...
// bindBN256 binds a generic wrapper to an already deployed kvtabletest.
...
// F is a free data retrieval call binding the kvtabletest method 0x72de3cbd.
//
...
// BigModExp is a paid mutator transaction binding the kvtabletest method 0x1aa5d42f.
//
...
// Bn256Add is a paid mutator transaction binding the kvtabletest method 0xfda5d626.
//
...
// Bn256Pairing is a paid mutator transaction binding the kvtabletest method 0x90ea88a1.
//
...
// Bn256ScalarMul is a paid mutator transaction binding the kvtabletest method 0x3adf65f5.
//
