...
// Cns is an auto generated Go binding around a Solidity kvtabletest.
type Cns struct {
	CnsCaller     // Read-only binding to the kvtabletest
	CnsTransactor // Write-only binding to the kvtabletest
	CnsFilterer   // Log filterer for kvtabletest events
}

// CnsCaller is an auto generated read-only Go binding around a Solidity kvtabletest.
type CnsCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CnsTransactor is an auto generated write-only Go binding around a Solidity kvtabletest.
type CnsTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CnsFilterer is an auto generated log filtering Go binding around a Solidity kvtabletest events.
type CnsFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CnsSession is an auto generated Go binding around a Solidity kvtabletest,
// with pre-set call and transact options.
type CnsSession struct {
	Contract     *Cns              // Generic kvtabletest binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// CnsCallerSession is an auto generated read-only Go binding around a Solidity kvtabletest,
// with pre-set call options.
type CnsCallerSession struct {
	Contract *CnsCaller    // Generic kvtabletest caller binding to set the session for
	CallOpts bind.CallOpts // Call options to use throughout this session
}

// CnsTransactorSession is an auto generated write-only Go binding around a Solidity kvtabletest,
// with pre-set transact options.
type CnsTransactorSession struct {
	Contract     *CnsTransactor    // Generic kvtabletest transactor binding to set the session for
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// CnsRaw is an auto generated low-level Go binding around a Solidity kvtabletest.
type CnsRaw struct {
	Contract *Cns // Generic kvtabletest binding to access the raw methods on
}

// CnsCallerRaw is an auto generated low-level read-only Go binding around a Solidity kvtabletest.
type CnsCallerRaw struct {
	Contract *CnsCaller // Generic read-only kvtabletest binding to access the raw methods on
}

// CnsTransactorRaw is an auto generated low-level write-only Go binding around a Solidity kvtabletest.
type CnsTransactorRaw struct {
	Contract *CnsTransactor // Generic write-only kvtabletest binding to access the raw methods on
}

// NewCns creates a new instance of Cns, bound to a specific deployed kvtabletest.
...
// NewCnsCaller creates a new read-only instance of Cns, bound to a specific deployed kvtabletest.
...
// NewCnsTransactor creates a new write-only instance of Cns, bound to a specific deployed kvtabletest.
...
// NewCnsFilterer creates a new log filterer instance of Cns, bound to a specific deployed kvtabletest.
...
// bindCns binds a generic wrapper to an already deployed kvtabletest.
...
// GetContractAddress is a free data retrieval call binding the kvtabletest method 0xf85f8126.
//
...
// SelectByName is a free data retrieval call binding the kvtabletest method 0x819a3d62.
//
...
// SelectByNameAndVersion is a free data retrieval call binding the kvtabletest method 0x897f0251.
//
