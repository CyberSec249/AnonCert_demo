...
// ContractLifeCycle is an auto generated Go binding around a Solidity kvtabletest.
type ContractLifeCycle struct {
	ContractLifeCycleCaller     // Read-only binding to the kvtabletest
	ContractLifeCycleTransactor // Write-only binding to the kvtabletest
	ContractLifeCycleFilterer   // Log filterer for kvtabletest events
}

// ContractLifeCycleCaller is an auto generated read-only Go binding around a Solidity kvtabletest.
type ContractLifeCycleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ContractLifeCycleTransactor is an auto generated write-only Go binding around a Solidity kvtabletest.
type ContractLifeCycleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ContractLifeCycleFilterer is an auto generated log filtering Go binding around a Solidity kvtabletest events.
type ContractLifeCycleFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ContractLifeCycleSession is an auto generated Go binding around a Solidity kvtabletest,
// with pre-set call and transact options.
type ContractLifeCycleSession struct {
	Contract     *ContractLifeCycle // Generic kvtabletest binding to set the session for
	CallOpts     bind.CallOpts      // Call options to use throughout this session
	TransactOpts bind.TransactOpts  // Transaction auth options to use throughout this session
}

// ContractLifeCycleCallerSession is an auto generated read-only Go binding around a Solidity kvtabletest,
// with pre-set call options.
type ContractLifeCycleCallerSession struct {
	Contract *ContractLifeCycleCaller // Generic kvtabletest caller binding to set the session for
	CallOpts bind.CallOpts            // Call options to use throughout this session
}

// ContractLifeCycleTransactorSession is an auto generated write-only Go binding around a Solidity kvtabletest,
// with pre-set transact options.
type ContractLifeCycleTransactorSession struct {
	Contract     *ContractLifeCycleTransactor // Generic kvtabletest transactor binding to set the session for
	TransactOpts bind.TransactOpts            // Transaction auth options to use throughout this session
}

// ContractLifeCycleRaw is an auto generated low-level Go binding around a Solidity kvtabletest.
type ContractLifeCycleRaw struct {
	Contract *ContractLifeCycle // Generic kvtabletest binding to access the raw methods on
}

// ContractLifeCycleCallerRaw is an auto generated low-level read-only Go binding around a Solidity kvtabletest.
type ContractLifeCycleCallerRaw struct {
	Contract *ContractLifeCycleCaller // Generic read-only kvtabletest binding to access the raw methods on
}

// ContractLifeCycleTransactorRaw is an auto generated low-level write-only Go binding around a Solidity kvtabletest.
type ContractLifeCycleTransactorRaw struct {
	Contract *ContractLifeCycleTransactor // Generic write-only kvtabletest binding to access the raw methods on
}

// NewContractLifeCycle creates a new instance of ContractLifeCycle, bound to a specific deployed kvtabletest.
...
// NewContractLifeCycleCaller creates a new read-only instance of ContractLifeCycle, bound to a specific deployed kvtabletest.
...
// NewContractLifeCycleTransactor creates a new write-only instance of ContractLifeCycle, bound to a specific deployed kvtabletest.
...
// NewContractLifeCycleFilterer creates a new log filterer instance of ContractLifeCycle, bound to a specific deployed kvtabletest.
...
// bindContractLifeCycle binds a generic wrapper to an already deployed kvtabletest.
...
// GetStatus is a free data retrieval call binding the kvtabletest method 0x30ccebb5.
//
...
// ListManager is a free data retrieval call binding the kvtabletest method 0xc5252d0e.
//
...
// Freeze is a paid mutator transaction binding the kvtabletest method 0x8d1fdf2f.
//
...
// GrantManager is a paid mutator transaction binding the kvtabletest method 0xa721fb43.
//
...
// Unfreeze is a paid mutator transaction binding the kvtabletest method 0x45c8b1a6.
//
