...
// Crud is an auto generated Go binding around a Solidity kvtabletest.
type Crud struct {
	CrudCaller     // Read-only binding to the kvtabletest
	CrudTransactor // Write-only binding to the kvtabletest
	CrudFilterer   // Log filterer for kvtabletest events
}

// CrudCaller is an auto generated read-only Go binding around a Solidity kvtabletest.
type CrudCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CrudTransactor is an auto generated write-only Go binding around a Solidity kvtabletest.
type CrudTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CrudFilterer is an auto generated log filtering Go binding around a Solidity kvtabletest events.
type CrudFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CrudSession is an auto generated Go binding around a Solidity kvtabletest,
// with pre-set call and transact options.
type CrudSession struct {
	Contract     *Crud             // Generic kvtabletest binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// CrudCallerSession is an auto generated read-only Go binding around a Solidity kvtabletest,
// with pre-set call options.
type CrudCallerSession struct {
	Contract *CrudCaller   // Generic kvtabletest caller binding to set the session for
	CallOpts bind.CallOpts // Call options to use throughout this session
}

// CrudTransactorSession is an auto generated write-only Go binding around a Solidity kvtabletest,
// with pre-set transact options.
type CrudTransactorSession struct {
	Contract     *CrudTransactor   // Generic kvtabletest transactor binding to set the session for
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// CrudRaw is an auto generated low-level Go binding around a Solidity kvtabletest.
type CrudRaw struct {
	Contract *Crud // Generic kvtabletest binding to access the raw methods on
}

// CrudCallerRaw is an auto generated low-level read-only Go binding around a Solidity kvtabletest.
type CrudCallerRaw struct {
	Contract *CrudCaller // Generic read-only kvtabletest binding to access the raw methods on
}

// CrudTransactorRaw is an auto generated low-level write-only Go binding around a Solidity kvtabletest.
type CrudTransactorRaw struct {
	Contract *CrudTransactor // Generic write-only kvtabletest binding to access the raw methods on
}

// NewCrud creates a new instance of Crud, bound to a specific deployed kvtabletest.
...
// NewCrudCaller creates a new read-only instance of Crud, bound to a specific deployed kvtabletest.
...
// NewCrudTransactor creates a new write-only instance of Crud, bound to a specific deployed kvtabletest.
...
// NewCrudFilterer creates a new log filterer instance of Crud, bound to a specific deployed kvtabletest.
...
// bindCrud binds a generic wrapper to an already deployed kvtabletest.
...
// Desc is a free data retrieval call binding the kvtabletest method 0x5d0d6d54.
//
...
// Select is a free data retrieval call binding the kvtabletest method 0x983c6c4f.
//
...
// Insert is a paid mutator transaction binding the kvtabletest method 0xa216464b.
//
...
// Remove is a paid mutator transaction binding the kvtabletest method 0xa72a1e65.
//
...
// Update is a paid mutator transaction binding the kvtabletest method 0x2dca76c1.
//
