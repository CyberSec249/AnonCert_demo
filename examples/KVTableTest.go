...
// DeployKVTableTest deploys a new kvtabletest, binding an instance of KVTableTest to it.
...
// KVTableTest is an auto generated Go binding around a Solidity kvtabletest.
type KVTableTest struct {
	KVTableTestCaller     // Read-only binding to the kvtabletest
	KVTableTestTransactor // Write-only binding to the kvtabletest
	KVTableTestFilterer   // Log filterer for kvtabletest events
}

// KVTableTestCaller is an auto generated read-only Go binding around a Solidity kvtabletest.
type KVTableTestCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// KVTableTestTransactor is an auto generated write-only Go binding around a Solidity kvtabletest.
type KVTableTestTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// KVTableTestFilterer is an auto generated log filtering Go binding around a Solidity kvtabletest events.
type KVTableTestFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// KVTableTestSession is an auto generated Go binding around a Solidity kvtabletest,
// with pre-set call and transact options.
type KVTableTestSession struct {
	Contract     *KVTableTest      // Generic kvtabletest binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// KVTableTestCallerSession is an auto generated read-only Go binding around a Solidity kvtabletest,
// with pre-set call options.
type KVTableTestCallerSession struct {
	Contract *KVTableTestCaller // Generic kvtabletest caller binding to set the session for
	CallOpts bind.CallOpts      // Call options to use throughout this session
}

// KVTableTestTransactorSession is an auto generated write-only Go binding around a Solidity kvtabletest,
// with pre-set transact options.
type KVTableTestTransactorSession struct {
	Contract     *KVTableTestTransactor // Generic kvtabletest transactor binding to set the session for
	TransactOpts bind.TransactOpts      // Transaction auth options to use throughout this session
}

// KVTableTestRaw is an auto generated low-level Go binding around a Solidity kvtabletest.
type KVTableTestRaw struct {
	Contract *KVTableTest // Generic kvtabletest binding to access the raw methods on
}

// KVTableTestCallerRaw is an auto generated low-level read-only Go binding around a Solidity kvtabletest.
type KVTableTestCallerRaw struct {
	Contract *KVTableTestCaller // Generic read-only kvtabletest binding to access the raw methods on
}

// KVTableTestTransactorRaw is an auto generated low-level write-only Go binding around a Solidity kvtabletest.
type KVTableTestTransactorRaw struct {
	Contract *KVTableTestTransactor // Generic write-only kvtabletest binding to access the raw methods on
}

// NewKVTableTest creates a new instance of KVTableTest, bound to a specific deployed kvtabletest.
...
// NewKVTableTestCaller creates a new read-only instance of KVTableTest, bound to a specific deployed kvtabletest.
...
// NewKVTableTestTransactor creates a new write-only instance of KVTableTest, bound to a specific deployed kvtabletest.
...
// NewKVTableTestFilterer creates a new log filterer instance of KVTableTest, bound to a specific deployed kvtabletest.
...
// bindKVTableTest binds a generic wrapper to an already deployed kvtabletest.
...
// Get is a free data retrieval call binding the kvtabletest method 0x693ec85e.
//
...
// Set is a paid mutator transaction binding the kvtabletest method 0xed0c8b17.
//
...
// KVTableTestSetResultIterator is returned from FilterSetResult and is used to iterate over the raw logs and unpacked data for SetResult events raised by the KVTableTest kvtabletest.
type KVTableTestSetResultIterator struct {
	Event *KVTableTestSetResult // Event containing the kvtabletest specifics and raw log
...
// KVTableTestSetResult represents a SetResult event raised by the KVTableTest kvtabletest.
type KVTableTestSetResult struct {
	Count *big.Int
	Raw   types.Log // Blockchain specific contextual infos
}

// ParseSetResult is a log parse operation binding the kvtabletest event 0xb103249d88cd818b10c5cd6889874103a7699c5834cb078d8f35925dca8a62d6.
//
